        ...
        <div class="product-overlay">
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 4.5C7.305 4.5 3.336 7.364 1.5 11.5c1.836 4.136 5.805 7 10.5 7s8.664-2.864 10.5-7c-1.836-4.136-5.805-7-10.5-7zm0 11.5c-2.485 0-4.5-2.015-4.5-4.5S9.515 7 12 7s4.5 2.015 4.5 4.5S14.485 16 12 16zm0-7c-1.38 0-2.5 1.12-2.5 2.5S10.62 14.5 12 14.5s2.5-1.12 2.5-2.5S13.38 9 12 9z"/>
            </svg>
            Vista Rápida
          </button>
        </div>
  ...
  styles: [`
    .product-card {
      ...
      &:hover {
        ...
        border-color: var(--primary-color, var(--tenant-primary-color, #1976d2));
      }
    }
